...
import image from '../../assets/images/events/recruit2021.jpg';
            ...
            <section className={classes}>
                ...
                <section className='article-main-content'>
                    <div className='article-wrapper'>
                        <h1 className='article-name'>Sự Kiện</h1>
                                ...
                                <div className='article-item' key={article.id}>
                                    <div className='container'>
                                        <div className='article-main-img'>
                                            <img src={image} alt='tuyencongtacvien' />
                                        </div>
                                        ...
                                        <div className='see-detail'>
                                            <Link className="see-detail-btn" to={location => `/event?id=${article.id}`}>Xem thêm</Link>
                                        </div>
                                    </div>
                                </div>
                            ))}
